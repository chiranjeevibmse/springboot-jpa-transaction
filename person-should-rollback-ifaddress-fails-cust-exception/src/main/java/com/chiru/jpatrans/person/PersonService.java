...
public class PersonService {
    ...
    public Person createAPerson(PersonCreateModel personModel) throws AddressNotCreated {
        Person p = new Person();
    ...
    @Transactional(propagation = Propagation.REQUIRED,rollbackFor = AddressNotCreated.class)
    public Person createAPersonRoleBackOnCustomException(PersonCreateModel personModel) throws AddressNotCreated {
        Person p = new Person();
        p.setName(personModel.getName());
        Person createdPerson = this.repo.save(p);
        AddressModel add = new AddressModel();
